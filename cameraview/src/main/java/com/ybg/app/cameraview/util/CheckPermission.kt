...
object CheckPermission {
    ...
    val recordState: Int
        get() {
            val minBuffer = AudioRecord.getMinBufferSize(44100, AudioFormat.CHANNEL_IN_MONO, AudioFormat
                    .ENCODING_PCM_16BIT)
            var audioRecord: AudioRecord? = AudioRecord(MediaRecorder.AudioSource.DEFAULT, 44100, AudioFormat
