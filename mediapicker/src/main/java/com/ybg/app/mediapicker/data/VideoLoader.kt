...
class VideoLoader(private var mContext: Context, private var mLoader: DataCallback) : LoaderM(),
        LoaderManager.LoaderCallbacks<Cursor> {
    private var MEDIA_PROJECTION = arrayOf(MediaStore.Files.FileColumns.DATA, MediaStore.Files
            .FileColumns.DISPLAY_NAME, MediaStore.Files.FileColumns.DATE_ADDED,
            MediaStore.Files.FileColumns.MEDIA_TYPE, MediaStore.Files.FileColumns.SIZE,
            MediaStore.Files.FileColumns._ID, MediaStore.Files.FileColumns.PARENT)
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, o: Cursor) {
        ...
        val allFolder = Folder(mContext.resources.getString(R.string.all_video))
        folders.add(allFolder)
        val cursor = o as Cursor
        Log.e("dmc", cursor.count.toString() + "数量数量")
